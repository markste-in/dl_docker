...
if [ $online -eq 0 ]; then
    ...
    docker pull sysfail/dl_docker_cpu:${tag}
    img_avilable=$?
...
docker run -it -p 8888:8888 -p 6006:6006 -p 5900:5900 -p 6080:6080 -p 22:22 -v ~/docker/share:/docker/share -w /docker sysfail/dl_docker_cpu:${tag}
